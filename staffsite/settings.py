"""
Django settings for staffsite project.
...
SECRET_KEY = env.str('SECRET_KEY', 'django-insecure-4re0$dkw#wk)+&7b7i!*$y2ry80_n0i^)ier@j51mm-z&b#k=j')
...
DATABASES = {
    'default': {
        ...
        'NAME': env.str('DB_NAME', 'employees'),
        'USER' : env.str('DB_USER', 'emp'),
